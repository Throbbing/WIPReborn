...
void WIPScene::load_level(int id,const RBVector2& pos)
{
  ...
  case 0:
    ...
    break;
  case 1:
    loader->load_caodi(pos);
    break;
  case 2:
    loader->load_huangdi(pos);
    break;
  case 3:
    loader->load_mudi(pos);
    break;
  default:
    break;
  }
...
void WIPScene::reload_level(int id)
{
	loader->test_reload_level();
}
...
void WIPScene::submit_level_change()
{
    ...
    //todo:restore cached persistent object

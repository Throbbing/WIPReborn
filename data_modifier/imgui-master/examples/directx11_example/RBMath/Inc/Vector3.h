...
public:
  ...
  FORCEINLINE RBVector3(f64 a) : x((f32)a), y((f32)a), z((f32)a){}
	...
	*/
	...
	// * @return					Path length.
	// */
	//static  f32 EvaluateBezier(const RBVector3* ControlPoints, int32 NumPoints, TArray<RBVector3>& OutPoints);
	...
	// */
	//static  void GenerateClusterCenters(TArray<RBVector3>& Clusters, const TArray<RBVector3>& Points, int32 NumIterations, int32 NumConnectionsToBeValid);
